...
public class SpecManagementServiceImpl implements SpecManagementService {
    ...
    public void copyServerTemplate(String serverTemplateId, String newServerTemplateId, String newServerTemplateName) {
        ...
        ((ServerTemplate)serverTemplate).setId(newServerTemplateId);
        ((ServerTemplate)serverTemplate).setName(newServerTemplateName);
    ...
    public void startContainer(ContainerSpecKey containerSpecKey) {
        ...
        ((ContainerSpec)containerSpec).setStatus(KieContainerStatus.STARTED);
    ...
    public void stopContainer(ContainerSpecKey containerSpecKey) {
        ...
        ((ContainerSpec)containerSpec).setStatus(KieContainerStatus.STOPPED);
