    ...
    public KieServerSetup connect(KieServerInfo serverInfo) {
        ...
        if (serverTemplate != null) {
            ...
            if (!serverTemplate.hasServerInstance(serverInfo.getLocation())) {
                ...
                serverTemplate.addServerInstance(serverInfo.getLocation());
            } else {
            ...
            serverTemplate = new ServerTemplateImpl();
            ((ServerTemplateImpl)serverTemplate).setId(serverInfo.getServerId());
            ((ServerTemplateImpl)serverTemplate).setName(serverInfo.getName());
