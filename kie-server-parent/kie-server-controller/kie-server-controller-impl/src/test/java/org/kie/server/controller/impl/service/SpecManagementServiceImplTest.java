...
public class SpecManagementServiceImplTest extends AbstractServiceImplTest {
    ...
    public void testStartContainer() {
        ...
        when(kieServerInstanceManager.startContainer(any(), any())).thenReturn(fakeResult);

        specManagementService.startContainer(containerSpec);

        verify(kieServerInstanceManager, times(1)).startContainer(any(), any());
    ...
    public void testStopContainer() {
        ...
        List<Container> fakeResult = new ArrayList<Container>();
        fakeResult.add(container);
        when(kieServerInstanceManager.stopContainer(any(), any())).thenReturn(fakeResult);

        specManagementService.stopContainer(containerSpec);

        verify(kieServerInstanceManager, times(1)).stopContainer(any(), any());
