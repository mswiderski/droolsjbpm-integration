...
public class RuntimeManagementServiceImplTest extends AbstractServiceImplTest {
    ...
    public void testGetServerInstances() {
        ...
        serverTemplate.addServerInstance(new ServerInstanceKey("instanceId", "test server", serverTemplate.getId(), "http://fake.url.org"));
    ...
    public void testGetContainers() {
        ...
        when(kieServerInstanceManager.getContainers(any())).thenReturn(fakeResult);
        ...
        verify(kieServerInstanceManager, times(1)).getContainers(any());
    }
