...
public class KieSpringTransactionManagerFactoryTest extends AbstractJbpmSpringParameterizedTest {
    ...
    public void testSomething() throws Exception {
        RuntimeManager manager = getSecondManager();
        assertNotNull(manager);
        Environment env = manager.getRuntimeEngine(runtimeManagerContext).getKieSession().getEnvironment();
        assertNotNull(env);

        Object txManager = env.get(EnvironmentName.TRANSACTION_MANAGER);
        assertNotNull(txManager);
    }
}
